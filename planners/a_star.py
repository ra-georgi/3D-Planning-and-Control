...
class AStar_Planner(Planner):
    ...
    def __init__(self, cfg):
        super().__init__(cfg)
        with open("config/planners/a_star.yaml", "r") as f:
    ...
    def calculate_trajectory(self): #-> str:
        ...
        planner_waypoints = []
        print("Starting A* for path planning")
        ...
        for i in range(len(self.waypoints) - 1):
            ...
            path = self.astar_plan(start, goal)
            planner_waypoints.append(path)
        
        print("Converting A* waypoints to trajectory")
    ...
    def astar_plan(self, start_pos, goal_pos):
